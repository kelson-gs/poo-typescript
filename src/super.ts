...
class Manager extends User {
    constructor(name: string, email: string, active: boolean, createdAt: string, code: string){
...
const manager1 = new Manager('Manager1','manager@gmail.com', true, 'asdasdadas', '123');
